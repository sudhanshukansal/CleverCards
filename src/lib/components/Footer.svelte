  ...
  <div class="relative mx-auto flex w-full flex-col gap-4">
    ...
    >
      ...
      {#each sections as section}
        <div>
          <h3
            class="mb-4 font-bold text-white text-subParaFont md:text-paraFont"
          >
            {section.title}
          </h3>
          <ul>
      ...
      <div class="flex flex-col gap-3 sm:gap-4 lg:order-first">
        ...
        <div class="">
          <h2 class="text-white font-bold text-subParaFont md:text-paraFont">
            {brand.tagline}
          </h2>
          <div>
            <p class="text-lightGray text-subParaFont md:text-paraFont">
              Follow us on:
            </p>
      ...
      >
        <h2 class="font-bold text-subParaFont md:text-paraFont text-white">
          {newsletter.title}
        </h2>
        ...
        <div class="flex flex-col sm:flex-row gap-4 max-w-[800px]">
          <input
            ...
            class="w-full sm:w-[70%] border rounded-3xl  px-4 py-2  md:py-1 outline-none "
          />
          <button
